        ...
        <div className="flex flex-col justify-center items-center gap-10 pb-10">
          ...
          <div className="card bg-base-100 w-11/12 flex flex-row shadow-lg m-3 rounded-3xl">
            ...
            <div className="card-body w-2/5">
              ...
              <p className="m-4">
                ...
                <li>
                  Déplacement de la voiture d'après le circuit calculé par l'IA
                  pour 5 essais au hasard
                </li>
              </p>
            </div>
          </div>
          ...
          <div className="card bg-base-100 w-11/12 flex flex-row shadow-lg m-3 rounded-3xl">
            ...
            <div className="card-body w-2/5">
              ...
              <p className="m-4">
                <li>
                  Ce jeu est une sorte de Bomberman, le but est de tuer tous les
                ...
                <li>Unity + C#</li>
                <li>
                  Déplacement dans la vue 3D avec clavier et sélection dans l'UI
                  2D à la souris
                </li>
                <li>
                ...
                <li>
                  Couleurs en fonction du monde (Neige, Volcan, Forêt, Marécage,
                  Désert)
                </li>
              </p>
            </div>
          ...
          <div className="card bg-base-100 w-11/12 flex flex-row shadow-lg m-3 rounded-3xl">
            ...
            <div className="card-body w-2/5">
              ...
              <p className="m-4">
                ...
                <li>
                  Système d'authentification par mot de passe et de gestion des
                  utilisateurs
                </li>
                <li>
                ...
                <li>
                  Mode claire et mode sombre celon les préférences de
                  l'utilisateur
                </li>
              </p>
            </div>
