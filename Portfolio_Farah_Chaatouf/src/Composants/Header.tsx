      ...
      <div className="w-4/5 h-screen flex justify-center items-center">
        <div className="hover-3d h-4/5 w-4/5  ">
          <div className="relative flex justify-center items-center rounded-3xl shadow-lg">
            ...
            <div className="bg-amber-200 w-3/5 h-1/3 flex flex-col text-6xl justify-center items-center text-center font-semibold font-serif bg-gradient-to-r from-blue-800 to-fuchsia-400 bg-clip-text text-transparent decoration-clone">
